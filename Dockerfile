...
RUN wget --header="Authorization: Bearer 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" https://huggingface.co/QuantFactory/Meta-Llama-3-8B-Instruct-GGUF/resolve/main/Meta-Llama-3-8B-Instruct.Q4_0.gguf
